...
import os
os.makedirs("quiz files")
os.makedirs("answer files")
for quizNum in range(35):
    # Create the quiz and answer key files.
    quizFile = open("quiz files/capitalsquiz%s.txt" %(quizNum+1),'w')
    answerKeyFile= open("answer files/capitalsquiz_answers%s.txt" %(quizNum+1),'w')
